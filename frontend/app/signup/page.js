  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#c4b0dc]  p-4">
      ...
      >
        ...
        <button
          type="submit"
          className="w-full h-11 rounded-xl bg-gradient-to-r from-[#7132CA] to-[#8C00FF] text-white outline-none cursor-pointer font-semibold tracking-wide hover:opacity-90 transition"
        >
          Sign Up
        </button>
